...
The admin module acts as a smart monitoring dashboard. Administrators can view all complaints, search records by ID, issue type, phone number, or status, and update complaints as resolved or delete them if needed. The system provides data export functionality for reporting and analysis. A visual analytics section displays issue distribution using charts, and an interactive map presents complaints with color-coded markers based on problem type. When multiple complaints occur in the same area, they automatically cluster together, helping authorities identify high-problem zones quickly.

This project demonstrates the practical application of database management, geolocation services, data visualization, and user-friendly interface design. It is designed as a production-ready civic-tech solution that can be deployed online to support smart city initiatives, improve public service response time, and encourage citizen participation in maintaining community infrastructure.
